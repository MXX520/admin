  ...
  <div id="app">
    ...
    <el-dialog title="添加审稿人" :visible.sync="dialogTableVisible">
      <el-form :inline="true" class="demo-form-inline">
        <el-form-item label="">
          <el-input v-model="queryAdd" placeholder=""></el-input>
        </el-form-item>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="addClick">查询</el-button>
        </el-form-item>
      </el-form>
      <el-table
        ref="multipleTable"
      ...
      >
        ...
        <el-table-column prop="id" type="index" label="序号" width="120">
        </el-table-column>
      ...
      <el-row type="flex" justify="center" align="middle">
        <el-button type="primary" class="btn" plain @click="addGrouping"
          >添加到分组</el-button
        >
      </el-row>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    async addClick() {
      ...
      let { data } = await this.$api.get("user/reviewer/list/" + this.id+'?query='+this.queryAdd);
