<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="forumName" label="对应论坛" align='center' width="120" >
			</el-table-column>
			<el-table-column prop="createTime" label="创建时间" align='center' width="100" >
			</el-table-column>
			<el-table-column prop="num" label="显示顺序" align='center' width="140" >
			</el-table-column>
	...
	export default {
		...
		//删除
			async handleDel (index, row) {
				...
				let {data} = await this.$api.get("carousel/"+row.id)
