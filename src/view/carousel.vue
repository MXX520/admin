	...
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column label="操作" align='center' width="250" >
				<template scope="scope">
                    ...
                    <el-button  size="small" @click="deleteImg(scope.$index, scope.row)">删除</el-button>
				</template>
			</el-table-column>
		</el-table>
		...
		<el-dialog title="轮播修改" :visible.sync="putVisible" :close-on-click-modal="false"  class="time">
			...
			<div slot="footer" class="dialog-footer" style="text-align:center;">
				...
				<el-button type="primary" @click.native="editChange" :loading="editLoading" >更改</el-button>
			</div>
		</el-dialog>
		<!--新增界面-->
