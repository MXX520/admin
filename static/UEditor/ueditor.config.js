...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: 'http://39.100.65.236:8093/mh/ueditor/config' //测试
      //  , serverUrl: 'http://39.106.77.121:8086/mh/ueditor/config'//正式
        ...
        , toolbars: [[
            ...
            'simpleupload', 'attachment', 'map', 'pagebreak', 'template', 'background', '|',
